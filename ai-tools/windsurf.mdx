...
description: "Configure Windsurf for your documentation workflowm"
icon: "water"
---
...
- Edited, Windsurf editor installed
- Replaced the word to your documentation repository

## Workspace rules

Create workspace rules that provide Windsurf with context about your documentation project 
